if (top == self) {
	...
	function keyu(e) {
		...
		} else if (key == 115 && wrapping.css("display") != "none" && mode == "plugin") {
	...
	window.parent.jQuery(document).bind("keyup", window.parent.keyu);
	window.parent.jQuery(document).bind("keydown", window.parent.keyd);
}
